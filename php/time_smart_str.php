...
// 示例
echo time_smart_str('2017-10-24 00:00:00'), "\n";
echo time_smart_str('2017-6-14'), "\n";
 ...
 *
 * @see: 可以用time_smart_ts，传$ts时把时间转成时间戳 time_smart_ts(strtotime($str))
 */
function time_smart_str($str, $days = 30)
{
    $ts = strtotime($str);
    $passed = time() - $ts;
